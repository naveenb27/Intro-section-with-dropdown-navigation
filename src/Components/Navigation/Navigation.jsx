        ...
        <div className={!navActive ? 'list' : 'dontshow-list'}>
          <div className="list-1 nav-list">
            ...
            <div className={navStatus ? 'feature-list' : 'hidden'}>
              <div>
                <img src="src\assets\images\icon-todo.svg" alt="todo" />
                <p>Todo List</p>
              </div>
              <div>
                <img src="src\assets\images\icon-calendar.svg" alt="todo" />
                <p>Calendar</p>
              </div>
              <div>
                <img src="src\assets\images\icon-reminders.svg" alt="todo" />
                <p>Reminders</p>
              </div>
              <div>
                <img src="src\assets\images\icon-planning.svg" alt="todo" />
                <p>Planing</p>
              </div>
            </div>
          </div>
